...
class SpyMimeTypeTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdMimeType', 'Comment', 'IsAllowed', 'Name', ],
        self::TYPE_CAMELNAME     => ['idMimeType', 'comment', 'isAllowed', 'name', ],
        self::TYPE_COLNAME       => [SpyMimeTypeTableMap::COL_ID_MIME_TYPE, SpyMimeTypeTableMap::COL_COMMENT, SpyMimeTypeTableMap::COL_IS_ALLOWED, SpyMimeTypeTableMap::COL_NAME, ],
        self::TYPE_FIELDNAME     => ['id_mime_type', 'comment', 'is_allowed', 'name', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdMimeType' => 0, 'Comment' => 1, 'IsAllowed' => 2, 'Name' => 3, ],
        self::TYPE_CAMELNAME     => ['idMimeType' => 0, 'comment' => 1, 'isAllowed' => 2, 'name' => 3, ],
        self::TYPE_COLNAME       => [SpyMimeTypeTableMap::COL_ID_MIME_TYPE => 0, SpyMimeTypeTableMap::COL_COMMENT => 1, SpyMimeTypeTableMap::COL_IS_ALLOWED => 2, SpyMimeTypeTableMap::COL_NAME => 3, ],
        self::TYPE_FIELDNAME     => ['id_mime_type' => 0, 'comment' => 1, 'is_allowed' => 2, 'name' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
