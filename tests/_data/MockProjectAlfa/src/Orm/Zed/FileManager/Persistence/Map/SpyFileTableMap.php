...
class SpyFileTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdFile', 'FkFileDirectory', 'FileName', ],
        self::TYPE_CAMELNAME     => ['idFile', 'fkFileDirectory', 'fileName', ],
        self::TYPE_COLNAME       => [SpyFileTableMap::COL_ID_FILE, SpyFileTableMap::COL_FK_FILE_DIRECTORY, SpyFileTableMap::COL_FILE_NAME, ],
        self::TYPE_FIELDNAME     => ['id_file', 'fk_file_directory', 'file_name', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdFile' => 0, 'FkFileDirectory' => 1, 'FileName' => 2, ],
        self::TYPE_CAMELNAME     => ['idFile' => 0, 'fkFileDirectory' => 1, 'fileName' => 2, ],
        self::TYPE_COLNAME       => [SpyFileTableMap::COL_ID_FILE => 0, SpyFileTableMap::COL_FK_FILE_DIRECTORY => 1, SpyFileTableMap::COL_FILE_NAME => 2, ],
        self::TYPE_FIELDNAME     => ['id_file' => 0, 'fk_file_directory' => 1, 'file_name' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
