...
class SpySalesOrderItemMetadataTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdSalesOrderItemMetadata', 'FkSalesOrderItem', 'Image', 'SuperAttributes', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idSalesOrderItemMetadata', 'fkSalesOrderItem', 'image', 'superAttributes', 'createdAt', 'updatedAt', ],
        ...
        self::TYPE_FIELDNAME     => ['id_sales_order_item_metadata', 'fk_sales_order_item', 'image', 'super_attributes', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdSalesOrderItemMetadata' => 0, 'FkSalesOrderItem' => 1, 'Image' => 2, 'SuperAttributes' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ],
        self::TYPE_CAMELNAME     => ['idSalesOrderItemMetadata' => 0, 'fkSalesOrderItem' => 1, 'image' => 2, 'superAttributes' => 3, 'createdAt' => 4, 'updatedAt' => 5, ],
        ...
        self::TYPE_FIELDNAME     => ['id_sales_order_item_metadata' => 0, 'fk_sales_order_item' => 1, 'image' => 2, 'super_attributes' => 3, 'created_at' => 4, 'updated_at' => 5, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, ]
    ];
