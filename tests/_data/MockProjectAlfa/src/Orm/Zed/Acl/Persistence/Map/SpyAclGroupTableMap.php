...
class SpyAclGroupTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdAclGroup', 'Name', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idAclGroup', 'name', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyAclGroupTableMap::COL_ID_ACL_GROUP, SpyAclGroupTableMap::COL_NAME, SpyAclGroupTableMap::COL_CREATED_AT, SpyAclGroupTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_acl_group', 'name', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdAclGroup' => 0, 'Name' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, ],
        self::TYPE_CAMELNAME     => ['idAclGroup' => 0, 'name' => 1, 'createdAt' => 2, 'updatedAt' => 3, ],
        self::TYPE_COLNAME       => [SpyAclGroupTableMap::COL_ID_ACL_GROUP => 0, SpyAclGroupTableMap::COL_NAME => 1, SpyAclGroupTableMap::COL_CREATED_AT => 2, SpyAclGroupTableMap::COL_UPDATED_AT => 3, ],
        self::TYPE_FIELDNAME     => ['id_acl_group' => 0, 'name' => 1, 'created_at' => 2, 'updated_at' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
