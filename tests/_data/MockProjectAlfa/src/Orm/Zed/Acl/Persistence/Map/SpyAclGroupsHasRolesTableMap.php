...
class SpyAclGroupsHasRolesTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['FkAclRole', 'FkAclGroup', ],
        self::TYPE_CAMELNAME     => ['fkAclRole', 'fkAclGroup', ],
        self::TYPE_COLNAME       => [SpyAclGroupsHasRolesTableMap::COL_FK_ACL_ROLE, SpyAclGroupsHasRolesTableMap::COL_FK_ACL_GROUP, ],
        self::TYPE_FIELDNAME     => ['fk_acl_role', 'fk_acl_group', ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['FkAclRole' => 0, 'FkAclGroup' => 1, ],
        self::TYPE_CAMELNAME     => ['fkAclRole' => 0, 'fkAclGroup' => 1, ],
        self::TYPE_COLNAME       => [SpyAclGroupsHasRolesTableMap::COL_FK_ACL_ROLE => 0, SpyAclGroupsHasRolesTableMap::COL_FK_ACL_GROUP => 1, ],
        self::TYPE_FIELDNAME     => ['fk_acl_role' => 0, 'fk_acl_group' => 1, ],
        self::TYPE_NUM           => [0, 1, ]
    ];
