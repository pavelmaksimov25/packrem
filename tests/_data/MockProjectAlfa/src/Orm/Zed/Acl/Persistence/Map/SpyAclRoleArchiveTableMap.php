...
class SpyAclRoleArchiveTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdAclRole', 'Name', 'CreatedAt', 'UpdatedAt', 'ArchivedAt', ],
        self::TYPE_CAMELNAME     => ['idAclRole', 'name', 'createdAt', 'updatedAt', 'archivedAt', ],
        self::TYPE_COLNAME       => [SpyAclRoleArchiveTableMap::COL_ID_ACL_ROLE, SpyAclRoleArchiveTableMap::COL_NAME, SpyAclRoleArchiveTableMap::COL_CREATED_AT, SpyAclRoleArchiveTableMap::COL_UPDATED_AT, SpyAclRoleArchiveTableMap::COL_ARCHIVED_AT, ],
        self::TYPE_FIELDNAME     => ['id_acl_role', 'name', 'created_at', 'updated_at', 'archived_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdAclRole' => 0, 'Name' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, 'ArchivedAt' => 4, ],
        self::TYPE_CAMELNAME     => ['idAclRole' => 0, 'name' => 1, 'createdAt' => 2, 'updatedAt' => 3, 'archivedAt' => 4, ],
        self::TYPE_COLNAME       => [SpyAclRoleArchiveTableMap::COL_ID_ACL_ROLE => 0, SpyAclRoleArchiveTableMap::COL_NAME => 1, SpyAclRoleArchiveTableMap::COL_CREATED_AT => 2, SpyAclRoleArchiveTableMap::COL_UPDATED_AT => 3, SpyAclRoleArchiveTableMap::COL_ARCHIVED_AT => 4, ],
        self::TYPE_FIELDNAME     => ['id_acl_role' => 0, 'name' => 1, 'created_at' => 2, 'updated_at' => 3, 'archived_at' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
