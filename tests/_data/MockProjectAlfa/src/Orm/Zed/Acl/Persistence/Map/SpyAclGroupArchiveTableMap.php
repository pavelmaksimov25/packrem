...
class SpyAclGroupArchiveTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdAclGroup', 'Name', 'CreatedAt', 'UpdatedAt', 'ArchivedAt', ],
        self::TYPE_CAMELNAME     => ['idAclGroup', 'name', 'createdAt', 'updatedAt', 'archivedAt', ],
        self::TYPE_COLNAME       => [SpyAclGroupArchiveTableMap::COL_ID_ACL_GROUP, SpyAclGroupArchiveTableMap::COL_NAME, SpyAclGroupArchiveTableMap::COL_CREATED_AT, SpyAclGroupArchiveTableMap::COL_UPDATED_AT, SpyAclGroupArchiveTableMap::COL_ARCHIVED_AT, ],
        self::TYPE_FIELDNAME     => ['id_acl_group', 'name', 'created_at', 'updated_at', 'archived_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdAclGroup' => 0, 'Name' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, 'ArchivedAt' => 4, ],
        self::TYPE_CAMELNAME     => ['idAclGroup' => 0, 'name' => 1, 'createdAt' => 2, 'updatedAt' => 3, 'archivedAt' => 4, ],
        self::TYPE_COLNAME       => [SpyAclGroupArchiveTableMap::COL_ID_ACL_GROUP => 0, SpyAclGroupArchiveTableMap::COL_NAME => 1, SpyAclGroupArchiveTableMap::COL_CREATED_AT => 2, SpyAclGroupArchiveTableMap::COL_UPDATED_AT => 3, SpyAclGroupArchiveTableMap::COL_ARCHIVED_AT => 4, ],
        self::TYPE_FIELDNAME     => ['id_acl_group' => 0, 'name' => 1, 'created_at' => 2, 'updated_at' => 3, 'archived_at' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
