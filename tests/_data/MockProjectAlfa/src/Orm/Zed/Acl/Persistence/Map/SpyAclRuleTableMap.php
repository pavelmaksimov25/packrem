...
class SpyAclRuleTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdAclRule', 'FkAclRole', 'Bundle', 'Controller', 'Action', 'Type', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idAclRule', 'fkAclRole', 'bundle', 'controller', 'action', 'type', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyAclRuleTableMap::COL_ID_ACL_RULE, SpyAclRuleTableMap::COL_FK_ACL_ROLE, SpyAclRuleTableMap::COL_BUNDLE, SpyAclRuleTableMap::COL_CONTROLLER, SpyAclRuleTableMap::COL_ACTION, SpyAclRuleTableMap::COL_TYPE, SpyAclRuleTableMap::COL_CREATED_AT, SpyAclRuleTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_acl_rule', 'fk_acl_role', 'bundle', 'controller', 'action', 'type', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdAclRule' => 0, 'FkAclRole' => 1, 'Bundle' => 2, 'Controller' => 3, 'Action' => 4, 'Type' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ],
        self::TYPE_CAMELNAME     => ['idAclRule' => 0, 'fkAclRole' => 1, 'bundle' => 2, 'controller' => 3, 'action' => 4, 'type' => 5, 'createdAt' => 6, 'updatedAt' => 7, ],
        self::TYPE_COLNAME       => [SpyAclRuleTableMap::COL_ID_ACL_RULE => 0, SpyAclRuleTableMap::COL_FK_ACL_ROLE => 1, SpyAclRuleTableMap::COL_BUNDLE => 2, SpyAclRuleTableMap::COL_CONTROLLER => 3, SpyAclRuleTableMap::COL_ACTION => 4, SpyAclRuleTableMap::COL_TYPE => 5, SpyAclRuleTableMap::COL_CREATED_AT => 6, SpyAclRuleTableMap::COL_UPDATED_AT => 7, ],
        self::TYPE_FIELDNAME     => ['id_acl_rule' => 0, 'fk_acl_role' => 1, 'bundle' => 2, 'controller' => 3, 'action' => 4, 'type' => 5, 'created_at' => 6, 'updated_at' => 7, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, 7, ]
    ];
