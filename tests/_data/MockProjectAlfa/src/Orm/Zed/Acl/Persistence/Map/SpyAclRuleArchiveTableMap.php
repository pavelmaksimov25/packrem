...
class SpyAclRuleArchiveTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdAclRule', 'FkAclRole', 'Bundle', 'Controller', 'Action', 'Type', 'CreatedAt', 'UpdatedAt', 'ArchivedAt', ],
        self::TYPE_CAMELNAME     => ['idAclRule', 'fkAclRole', 'bundle', 'controller', 'action', 'type', 'createdAt', 'updatedAt', 'archivedAt', ],
        ...
        self::TYPE_FIELDNAME     => ['id_acl_rule', 'fk_acl_role', 'bundle', 'controller', 'action', 'type', 'created_at', 'updated_at', 'archived_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdAclRule' => 0, 'FkAclRole' => 1, 'Bundle' => 2, 'Controller' => 3, 'Action' => 4, 'Type' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, 'ArchivedAt' => 8, ],
        self::TYPE_CAMELNAME     => ['idAclRule' => 0, 'fkAclRole' => 1, 'bundle' => 2, 'controller' => 3, 'action' => 4, 'type' => 5, 'createdAt' => 6, 'updatedAt' => 7, 'archivedAt' => 8, ],
        ...
        self::TYPE_FIELDNAME     => ['id_acl_rule' => 0, 'fk_acl_role' => 1, 'bundle' => 2, 'controller' => 3, 'action' => 4, 'type' => 5, 'created_at' => 6, 'updated_at' => 7, 'archived_at' => 8, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, 7, 8, ]
    ];
