...
class SpyAclRoleTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdAclRole', 'Name', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idAclRole', 'name', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyAclRoleTableMap::COL_ID_ACL_ROLE, SpyAclRoleTableMap::COL_NAME, SpyAclRoleTableMap::COL_CREATED_AT, SpyAclRoleTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_acl_role', 'name', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdAclRole' => 0, 'Name' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, ],
        self::TYPE_CAMELNAME     => ['idAclRole' => 0, 'name' => 1, 'createdAt' => 2, 'updatedAt' => 3, ],
        self::TYPE_COLNAME       => [SpyAclRoleTableMap::COL_ID_ACL_ROLE => 0, SpyAclRoleTableMap::COL_NAME => 1, SpyAclRoleTableMap::COL_CREATED_AT => 2, SpyAclRoleTableMap::COL_UPDATED_AT => 3, ],
        self::TYPE_FIELDNAME     => ['id_acl_role' => 0, 'name' => 1, 'created_at' => 2, 'updated_at' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
