...
class SpyMerchantRelationshipTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdMerchantRelationship', 'FkCompanyBusinessUnit', 'FkMerchant', 'MerchantRelationshipKey', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idMerchantRelationship', 'fkCompanyBusinessUnit', 'fkMerchant', 'merchantRelationshipKey', 'createdAt', 'updatedAt', ],
        ...
        self::TYPE_FIELDNAME     => ['id_merchant_relationship', 'fk_company_business_unit', 'fk_merchant', 'merchant_relationship_key', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdMerchantRelationship' => 0, 'FkCompanyBusinessUnit' => 1, 'FkMerchant' => 2, 'MerchantRelationshipKey' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ],
        self::TYPE_CAMELNAME     => ['idMerchantRelationship' => 0, 'fkCompanyBusinessUnit' => 1, 'fkMerchant' => 2, 'merchantRelationshipKey' => 3, 'createdAt' => 4, 'updatedAt' => 5, ],
        ...
        self::TYPE_FIELDNAME     => ['id_merchant_relationship' => 0, 'fk_company_business_unit' => 1, 'fk_merchant' => 2, 'merchant_relationship_key' => 3, 'created_at' => 4, 'updated_at' => 5, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, ]
    ];
