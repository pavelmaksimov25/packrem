...
class SpyStoreListStorageTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdStoreListStorage', 'Key', 'Data', 'AliasKeys', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idStoreListStorage', 'key', 'data', 'aliasKeys', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyStoreListStorageTableMap::COL_ID_STORE_LIST_STORAGE, SpyStoreListStorageTableMap::COL_KEY, SpyStoreListStorageTableMap::COL_DATA, SpyStoreListStorageTableMap::COL_ALIAS_KEYS, SpyStoreListStorageTableMap::COL_CREATED_AT, SpyStoreListStorageTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_store_list_storage', 'key', 'data', 'alias_keys', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdStoreListStorage' => 0, 'Key' => 1, 'Data' => 2, 'AliasKeys' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ],
        self::TYPE_CAMELNAME     => ['idStoreListStorage' => 0, 'key' => 1, 'data' => 2, 'aliasKeys' => 3, 'createdAt' => 4, 'updatedAt' => 5, ],
        self::TYPE_COLNAME       => [SpyStoreListStorageTableMap::COL_ID_STORE_LIST_STORAGE => 0, SpyStoreListStorageTableMap::COL_KEY => 1, SpyStoreListStorageTableMap::COL_DATA => 2, SpyStoreListStorageTableMap::COL_ALIAS_KEYS => 3, SpyStoreListStorageTableMap::COL_CREATED_AT => 4, SpyStoreListStorageTableMap::COL_UPDATED_AT => 5, ],
        self::TYPE_FIELDNAME     => ['id_store_list_storage' => 0, 'key' => 1, 'data' => 2, 'alias_keys' => 3, 'created_at' => 4, 'updated_at' => 5, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, ]
    ];
    ...
    {
        return [
            'synchronization' => ['resource' => ['value' => 'store_list'], 'queue_group' => ['value' => 'sync.storage.store'], 'queue_pool' => NULL],
