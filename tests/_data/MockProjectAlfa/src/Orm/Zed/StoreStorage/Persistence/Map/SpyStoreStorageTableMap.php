...
class SpyStoreStorageTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdSpyStoreStorage', 'FkStore', 'StoreName', 'Data', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idSpyStoreStorage', 'fkStore', 'storeName', 'data', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyStoreStorageTableMap::COL_ID_SPY_STORE_STORAGE, SpyStoreStorageTableMap::COL_FK_STORE, SpyStoreStorageTableMap::COL_STORE_NAME, SpyStoreStorageTableMap::COL_DATA, SpyStoreStorageTableMap::COL_ALIAS_KEYS, SpyStoreStorageTableMap::COL_KEY, SpyStoreStorageTableMap::COL_CREATED_AT, SpyStoreStorageTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_spy_store_storage', 'fk_store', 'store_name', 'data', 'alias_keys', 'key', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdSpyStoreStorage' => 0, 'FkStore' => 1, 'StoreName' => 2, 'Data' => 3, 'AliasKeys' => 4, 'Key' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ],
        self::TYPE_CAMELNAME     => ['idSpyStoreStorage' => 0, 'fkStore' => 1, 'storeName' => 2, 'data' => 3, 'aliasKeys' => 4, 'key' => 5, 'createdAt' => 6, 'updatedAt' => 7, ],
        self::TYPE_COLNAME       => [SpyStoreStorageTableMap::COL_ID_SPY_STORE_STORAGE => 0, SpyStoreStorageTableMap::COL_FK_STORE => 1, SpyStoreStorageTableMap::COL_STORE_NAME => 2, SpyStoreStorageTableMap::COL_DATA => 3, SpyStoreStorageTableMap::COL_ALIAS_KEYS => 4, SpyStoreStorageTableMap::COL_KEY => 5, SpyStoreStorageTableMap::COL_CREATED_AT => 6, SpyStoreStorageTableMap::COL_UPDATED_AT => 7, ],
        self::TYPE_FIELDNAME     => ['id_spy_store_storage' => 0, 'fk_store' => 1, 'store_name' => 2, 'data' => 3, 'alias_keys' => 4, 'key' => 5, 'created_at' => 6, 'updated_at' => 7, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, 7, ]
    ];
    ...
    {
        return [
            'synchronization' => ['resource' => ['value' => 'store'], 'queue_group' => ['value' => 'sync.storage.store'], 'queue_pool' => NULL, 'key_suffix_column' => ['value' => 'store_name']],
