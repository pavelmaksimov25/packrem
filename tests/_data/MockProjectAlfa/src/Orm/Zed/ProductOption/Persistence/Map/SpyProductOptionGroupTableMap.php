...
class SpyProductOptionGroupTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdProductOptionGroup', 'FkTaxSet', 'Active', 'Name', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idProductOptionGroup', 'fkTaxSet', 'active', 'name', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyProductOptionGroupTableMap::COL_ID_PRODUCT_OPTION_GROUP, SpyProductOptionGroupTableMap::COL_FK_TAX_SET, SpyProductOptionGroupTableMap::COL_ACTIVE, SpyProductOptionGroupTableMap::COL_NAME, SpyProductOptionGroupTableMap::COL_CREATED_AT, SpyProductOptionGroupTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_product_option_group', 'fk_tax_set', 'active', 'name', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdProductOptionGroup' => 0, 'FkTaxSet' => 1, 'Active' => 2, 'Name' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ],
        self::TYPE_CAMELNAME     => ['idProductOptionGroup' => 0, 'fkTaxSet' => 1, 'active' => 2, 'name' => 3, 'createdAt' => 4, 'updatedAt' => 5, ],
        self::TYPE_COLNAME       => [SpyProductOptionGroupTableMap::COL_ID_PRODUCT_OPTION_GROUP => 0, SpyProductOptionGroupTableMap::COL_FK_TAX_SET => 1, SpyProductOptionGroupTableMap::COL_ACTIVE => 2, SpyProductOptionGroupTableMap::COL_NAME => 3, SpyProductOptionGroupTableMap::COL_CREATED_AT => 4, SpyProductOptionGroupTableMap::COL_UPDATED_AT => 5, ],
        self::TYPE_FIELDNAME     => ['id_product_option_group' => 0, 'fk_tax_set' => 1, 'active' => 2, 'name' => 3, 'created_at' => 4, 'updated_at' => 5, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, ]
    ];
