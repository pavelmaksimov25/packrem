...
abstract class SpyPaymentMethod implements ActiveRecordInterface
{
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : SpyPaymentMethodTableMap::translateFieldName('PaymentMethodKey', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 11; // 11 = SpyPaymentMethodTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray(string $keyType = TableMap::TYPE_FIELDNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[10] => $this->getPaymentMethodKey(),
        ];
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[10], $arr)) {
            $this->setPaymentMethodKey($arr[$keys[10]]);
        }
