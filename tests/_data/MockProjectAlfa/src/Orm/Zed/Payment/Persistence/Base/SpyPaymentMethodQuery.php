...
abstract class SpyPaymentMethodQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id_payment_method`, `fk_payment_provider`, `group_name`, `is_active`, `is_foreign`, `is_hidden`, `label_name`, `last_message_timestamp`, `name`, `payment_authorization_endpoint`, `payment_method_key` FROM `spy_payment_method` WHERE `id_payment_method` = :p0';
        try {
