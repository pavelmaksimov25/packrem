...
class SpySalesReturnTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdSalesReturn', 'CustomerReference', 'ReturnReference', 'Store', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idSalesReturn', 'customerReference', 'returnReference', 'store', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpySalesReturnTableMap::COL_ID_SALES_RETURN, SpySalesReturnTableMap::COL_CUSTOMER_REFERENCE, SpySalesReturnTableMap::COL_RETURN_REFERENCE, SpySalesReturnTableMap::COL_STORE, SpySalesReturnTableMap::COL_CREATED_AT, SpySalesReturnTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_sales_return', 'customer_reference', 'return_reference', 'store', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdSalesReturn' => 0, 'CustomerReference' => 1, 'ReturnReference' => 2, 'Store' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ],
        self::TYPE_CAMELNAME     => ['idSalesReturn' => 0, 'customerReference' => 1, 'returnReference' => 2, 'store' => 3, 'createdAt' => 4, 'updatedAt' => 5, ],
        self::TYPE_COLNAME       => [SpySalesReturnTableMap::COL_ID_SALES_RETURN => 0, SpySalesReturnTableMap::COL_CUSTOMER_REFERENCE => 1, SpySalesReturnTableMap::COL_RETURN_REFERENCE => 2, SpySalesReturnTableMap::COL_STORE => 3, SpySalesReturnTableMap::COL_CREATED_AT => 4, SpySalesReturnTableMap::COL_UPDATED_AT => 5, ],
        self::TYPE_FIELDNAME     => ['id_sales_return' => 0, 'customer_reference' => 1, 'return_reference' => 2, 'store' => 3, 'created_at' => 4, 'updated_at' => 5, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, ]
    ];
