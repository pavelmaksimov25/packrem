 ...
 *
 * @method     ChildSpyOmsStateMachineLock[]|Collection findByIdOmsStateMachineLock(int|array<int> $id_oms_state_machine_lock) Return ChildSpyOmsStateMachineLock objects filtered by the id_oms_state_machine_lock column
 * @psalm-method Collection&\Traversable<ChildSpyOmsStateMachineLock> findByIdOmsStateMachineLock(int|array<int> $id_oms_state_machine_lock) Return ChildSpyOmsStateMachineLock objects filtered by the id_oms_state_machine_lock column
