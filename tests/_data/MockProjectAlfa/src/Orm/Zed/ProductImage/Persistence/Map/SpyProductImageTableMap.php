...
class SpyProductImageTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdProductImage', 'ExternalUrlLarge', 'ExternalUrlSmall', 'ProductImageKey', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idProductImage', 'externalUrlLarge', 'externalUrlSmall', 'productImageKey', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyProductImageTableMap::COL_ID_PRODUCT_IMAGE, SpyProductImageTableMap::COL_EXTERNAL_URL_LARGE, SpyProductImageTableMap::COL_EXTERNAL_URL_SMALL, SpyProductImageTableMap::COL_PRODUCT_IMAGE_KEY, SpyProductImageTableMap::COL_CREATED_AT, SpyProductImageTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_product_image', 'external_url_large', 'external_url_small', 'product_image_key', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdProductImage' => 0, 'ExternalUrlLarge' => 1, 'ExternalUrlSmall' => 2, 'ProductImageKey' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ],
        self::TYPE_CAMELNAME     => ['idProductImage' => 0, 'externalUrlLarge' => 1, 'externalUrlSmall' => 2, 'productImageKey' => 3, 'createdAt' => 4, 'updatedAt' => 5, ],
        self::TYPE_COLNAME       => [SpyProductImageTableMap::COL_ID_PRODUCT_IMAGE => 0, SpyProductImageTableMap::COL_EXTERNAL_URL_LARGE => 1, SpyProductImageTableMap::COL_EXTERNAL_URL_SMALL => 2, SpyProductImageTableMap::COL_PRODUCT_IMAGE_KEY => 3, SpyProductImageTableMap::COL_CREATED_AT => 4, SpyProductImageTableMap::COL_UPDATED_AT => 5, ],
        self::TYPE_FIELDNAME     => ['id_product_image' => 0, 'external_url_large' => 1, 'external_url_small' => 2, 'product_image_key' => 3, 'created_at' => 4, 'updated_at' => 5, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, ]
    ];
