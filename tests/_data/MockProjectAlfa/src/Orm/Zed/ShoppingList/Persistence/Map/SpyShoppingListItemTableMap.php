...
class SpyShoppingListItemTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdShoppingListItem', 'FkShoppingList', 'Key', 'ProductConfigurationInstanceData', 'Quantity', 'Sku', 'Uuid', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idShoppingListItem', 'fkShoppingList', 'key', 'productConfigurationInstanceData', 'quantity', 'sku', 'uuid', 'createdAt', 'updatedAt', ],
        ...
        self::TYPE_FIELDNAME     => ['id_shopping_list_item', 'fk_shopping_list', 'key', 'product_configuration_instance_data', 'quantity', 'sku', 'uuid', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdShoppingListItem' => 0, 'FkShoppingList' => 1, 'Key' => 2, 'ProductConfigurationInstanceData' => 3, 'Quantity' => 4, 'Sku' => 5, 'Uuid' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ],
        self::TYPE_CAMELNAME     => ['idShoppingListItem' => 0, 'fkShoppingList' => 1, 'key' => 2, 'productConfigurationInstanceData' => 3, 'quantity' => 4, 'sku' => 5, 'uuid' => 6, 'createdAt' => 7, 'updatedAt' => 8, ],
        self::TYPE_COLNAME       => [SpyShoppingListItemTableMap::COL_ID_SHOPPING_LIST_ITEM => 0, SpyShoppingListItemTableMap::COL_FK_SHOPPING_LIST => 1, SpyShoppingListItemTableMap::COL_KEY => 2, SpyShoppingListItemTableMap::COL_PRODUCT_CONFIGURATION_INSTANCE_DATA => 3, SpyShoppingListItemTableMap::COL_QUANTITY => 4, SpyShoppingListItemTableMap::COL_SKU => 5, SpyShoppingListItemTableMap::COL_UUID => 6, SpyShoppingListItemTableMap::COL_CREATED_AT => 7, SpyShoppingListItemTableMap::COL_UPDATED_AT => 8, ],
        self::TYPE_FIELDNAME     => ['id_shopping_list_item' => 0, 'fk_shopping_list' => 1, 'key' => 2, 'product_configuration_instance_data' => 3, 'quantity' => 4, 'sku' => 5, 'uuid' => 6, 'created_at' => 7, 'updated_at' => 8, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, 7, 8, ]
    ];
