...
abstract class SpyShoppingListItemQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id_shopping_list_item`, `fk_shopping_list`, `key`, `product_configuration_instance_data`, `quantity`, `sku`, `uuid`, `created_at`, `updated_at` FROM `spy_shopping_list_item` WHERE `id_shopping_list_item` = :p0';
        try {
