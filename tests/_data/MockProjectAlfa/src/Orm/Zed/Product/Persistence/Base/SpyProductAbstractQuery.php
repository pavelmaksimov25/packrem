 ...
 * @method     ChildSpyProductAbstract[]|Collection findByPyzColorCode(string|array<string> $pyz_color_code) Return ChildSpyProductAbstract objects filtered by the pyz_color_code column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstract> findByPyzColorCode(string|array<string> $pyz_color_code) Return ChildSpyProductAbstract objects filtered by the pyz_color_code column
