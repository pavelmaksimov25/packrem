...
class SpyProductAbstractTableMap extends TableMap
{
     ...
     */
    public const COL_PYZ_COLOR_CODE = 'spy_product_abstract.pyz_color_code';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdProductAbstract', 'FkTaxSet', 'Attributes', 'NewFrom', 'NewTo', 'PyzColorCode', 'Sku', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idProductAbstract', 'fkTaxSet', 'attributes', 'newFrom', 'newTo', 'pyzColorCode', 'sku', 'createdAt', 'updatedAt', ],
        ...
        self::TYPE_FIELDNAME     => ['id_product_abstract', 'fk_tax_set', 'attributes', 'new_from', 'new_to', 'pyz_color_code', 'sku', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdProductAbstract' => 0, 'FkTaxSet' => 1, 'Attributes' => 2, 'NewFrom' => 3, 'NewTo' => 4, 'PyzColorCode' => 5, 'Sku' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ],
        self::TYPE_CAMELNAME     => ['idProductAbstract' => 0, 'fkTaxSet' => 1, 'attributes' => 2, 'newFrom' => 3, 'newTo' => 4, 'pyzColorCode' => 5, 'sku' => 6, 'createdAt' => 7, 'updatedAt' => 8, ],
        ...
        self::TYPE_FIELDNAME     => ['id_product_abstract' => 0, 'fk_tax_set' => 1, 'attributes' => 2, 'new_from' => 3, 'new_to' => 4, 'pyz_color_code' => 5, 'sku' => 6, 'created_at' => 7, 'updated_at' => 8, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, 7, 8, ]
    ];
