...
class SortTransfer extends AbstractTransfer
{
    ...
    /**
     * @module Category|Currency|GlueApplication|GlueJsonApiConvention|MerchantRelationship|ProductConfiguration|ProductImage|ProductLabelDiscountConnector|ProductLabelSearch|ProductLabelStorage|ProductLabel|Product|Shipment|Url
     *
