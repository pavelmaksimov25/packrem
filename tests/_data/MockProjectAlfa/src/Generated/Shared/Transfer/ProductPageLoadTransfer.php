...
class ProductPageLoadTransfer extends AbstractTransfer
{
     ...
     * @var string
     */
    public const PAYLOAD_TRANSFERS = 'payloadTransfers';
    ...
    protected $transferPropertyNameMap = [
        ...
        'ProductAbstractIds' => 'productAbstractIds',
        'payload_transfers' => 'payloadTransfers',
        'payloadTransfers' => 'payloadTransfers',
        'PayloadTransfers' => 'payloadTransfers',
    ];
    ...
    protected $transferMetadata = [
        ...
        self::PAYLOAD_TRANSFERS => [
            'type' => 'array',
            'type_shim' => null,
            'name_underscore' => 'payload_transfers',
            'is_collection' => false,
            'is_transfer' => false,
            'is_value_object' => false,
            'rest_request_parameter' => 'no',
     ...
     * @module ProductCategorySearch|ProductLabelSearch|ProductListSearch|ProductPageSearch|ProductReviewSearch|SalesProductConnector
     *
     * @param array|null $payloadTransfers
     *
     * @return $this
     */
    public function setPayloadTransfers(array $payloadTransfers = null)
    {
        if ($payloadTransfers === null) {
            $payloadTransfers = [];
        }

        $this->payloadTransfers = $payloadTransfers;
        $this->modifiedProperties[self::PAYLOAD_TRANSFERS] = true;
     ...
     * @return array
     */
    public function getPayloadTransfers()
    {
        return $this->payloadTransfers;
    }

    /**
     * @module ProductCategorySearch|ProductLabelSearch|ProductListSearch|ProductPageSearch|ProductReviewSearch|SalesProductConnector
     *
     * @param mixed $payloadTransfers
     *
     * @return $this
     */
    public function addPayloadTransfers($payloadTransfers)
    {
        $this->payloadTransfers[] = $payloadTransfers;
        $this->modifiedProperties[self::PAYLOAD_TRANSFERS] = true;
     ...
     * @return $this
     */
    public function requirePayloadTransfers()
    {
        $this->assertPropertyIsSet(self::PAYLOAD_TRANSFERS);
    ...
    public function toArrayNotRecursiveCamelCased(): array
    {
        return [
            ...
            'payloadTransfers' => $this->payloadTransfers,
        ];
    }
    ...
    public function toArrayNotRecursiveNotCamelCased(): array
    {
        return [
            ...
            'payload_transfers' => $this->payloadTransfers,
        ];
    }
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'payload_transfers' => $this->payloadTransfers instanceof AbstractTransfer ? $this->payloadTransfers->toArray(true, false) : $this->payloadTransfers,
        ];
    }
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'payloadTransfers' => $this->payloadTransfers instanceof AbstractTransfer ? $this->payloadTransfers->toArray(true, true) : $this->payloadTransfers,
        ];
    }
}
