 ...
 */
class SearchHttpResponseFacetHierarchicalCategoriesTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
     ...
     * @return $this
     */
    public function setCategoriesOrFail($categories)
    {
        if ($categories === null) {
            $this->throwNullValueException(static::CATEGORIES);
        }
     ...
     * @return string
     */
    public function getCategoriesOrFail()
    {
