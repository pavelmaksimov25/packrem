 ...
 */
class PriceProductMerchantRelationshipCollectionDeleteCriteriaTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
     ...
     * @module PriceProductMerchantRelationship
     *
     * @param int $priceProductStoreId
     *
     * @return $this
     */
    public function addPriceProductStoreId($priceProductStoreId)
    {
        $this->priceProductStoreIds[] = $priceProductStoreId;
        $this->modifiedProperties[self::PRICE_PRODUCT_STORE_IDS] = true;
