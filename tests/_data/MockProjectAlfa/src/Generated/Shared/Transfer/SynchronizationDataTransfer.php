...
class SynchronizationDataTransfer extends AbstractTransfer
{
    ...
    /**
     * @module AssetStorage|AvailabilityStorage|CategoryImageStorage|CategoryStorage|CmsBlockCategoryStorage|CmsBlockProductStorage|CmsBlockStorage|CmsSlotBlockStorage|CmsSlotStorage|CmsStorage|CompanyUserStorage|ConfigurableBundleStorage|ContentStorage|CustomerStorage|EntityTag|FileManagerStorage|GlossaryStorage|NavigationStorage|PriceProductMerchantRelationshipStorage|PriceProductStorage|ProductAlternativeStorage|ProductBundleStorage|ProductCategoryFilterStorage|ProductCategoryStorage|ProductConfigurationStorage|ProductDiscontinuedStorage|ProductGroupStorage|ProductImageStorage|ProductLabelStorage|ProductListStorage|ProductMeasurementUnitStorage|ProductOptionStorage|ProductPackagingUnitStorage|ProductQuantityStorage|ProductRelationStorage|ProductResourceAliasStorage|ProductReviewStorage|ProductSetStorage|ProductStorage|ShoppingListStorage|StoreStorage|Synchronization|TaxProductStorage|TaxStorage|UrlStorage
     *
    ...
    /**
     * @module AssetStorage|CategoryImageStorage|CmsSlotBlockStorage|CmsSlotStorage|CompanyUserStorage|ConfigurableBundlePageSearch|ConfigurableBundleStorage|ContentStorage|CustomerAccessStorage|CustomerStorage|FileManagerStorage|GlossaryStorage|PriceProductMerchantRelationshipStorage|ProductAlternativeStorage|ProductConfigurationStorage|ProductDiscontinuedStorage|ProductListStorage|ProductMeasurementUnitStorage|ProductPackagingUnitStorage|ProductPageSearch|ProductQuantityStorage|SalesReturnSearch|ShoppingListStorage|StoreStorage|Synchronization|TaxProductStorage|TaxStorage
     *
    ...
    /**
     * @module AssetStorage|CategoryImageStorage|CmsSlotBlockStorage|CmsSlotStorage|CompanyUserStorage|ConfigurableBundlePageSearch|ConfigurableBundleStorage|ContentStorage|CustomerAccessStorage|EntityTag|FileManagerStorage|GlossaryStorage|PriceProductMerchantRelationshipStorage|ProductAlternativeStorage|ProductConfigurationStorage|ProductDiscontinuedStorage|ProductListStorage|ProductMeasurementUnitStorage|ProductPackagingUnitStorage|ProductPageSearch|ProductQuantityStorage|SalesReturnSearch|ShoppingListStorage|StoreStorage|Synchronization|TaxProductStorage|TaxStorage
     *
