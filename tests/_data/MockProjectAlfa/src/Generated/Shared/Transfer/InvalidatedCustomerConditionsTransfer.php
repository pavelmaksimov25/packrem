 ...
 */
class InvalidatedCustomerConditionsTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    public function setCustomerReferences(array $customerReferences = null)
    {
        ...
        foreach ($customerReferences as $key => $value) {
            $args = [$value];

            if ($this->transferMetadata[static::CUSTOMER_REFERENCES]['is_associative']) {
                $args = [$key, $value];
            }

            $this->addCustomerReference(...$args);
        }
     ...
     * @return $this
     */
    public function addCustomerReference(string $customerReference)
    {
