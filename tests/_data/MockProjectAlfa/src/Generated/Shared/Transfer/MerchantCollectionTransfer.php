 ...
 */
class MerchantCollectionTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @var \ArrayObject|\Generated\Shared\Transfer\MerchantTransfer[]
     */
    protected $merchants;
    ...
    /**
     * @module MerchantGui|MerchantRelationshipGui|Merchant
     *
     * @param \ArrayObject|\Generated\Shared\Transfer\MerchantTransfer[] $merchants
     *
     * @return $this
     */
     ...
     * @module MerchantGui|MerchantRelationshipGui|Merchant
     *
     * @param \Generated\Shared\Transfer\MerchantTransfer $merchants
     *
     * @return $this
     */
    public function addMerchants(MerchantTransfer $merchants)
    {
        $this->merchants[] = $merchants;
        $this->modifiedProperties[self::MERCHANTS] = true;
