 ...
 */
class ProductConfigurationFilterTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @module ProductConfigurationDataImport
     *
     ...
     * @module ProductConfigurationDataImport
     *
     * @param int $productConfigurationId
     *
     * @return $this
     */
    public function addProductConfigurationId($productConfigurationId)
    {
        $this->productConfigurationIds[] = $productConfigurationId;
        $this->modifiedProperties[self::PRODUCT_CONFIGURATION_IDS] = true;
