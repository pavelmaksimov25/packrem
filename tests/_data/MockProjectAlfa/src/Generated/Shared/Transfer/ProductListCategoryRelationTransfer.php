 ...
 */
class ProductListCategoryRelationTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @module ConfigurableBundleGui|ProductListGui|ProductList
     *
     ...
     * @return $this
     */
    public function addCategoryIds($categoryIds)
    {
        $this->categoryIds[] = $categoryIds;
        $this->modifiedProperties[self::CATEGORY_IDS] = true;
