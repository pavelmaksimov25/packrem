 ...
 */
class ProductCategoryFilterStorageTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @module CatalogPage|ProductCategoryFilterStorage
     *
     * @param array|null $filterData
     *
     * @return $this
     */
    public function setFilterData(array $filterData = null)
    {
        if ($filterData === null) {
            $filterData = [];
        }
     ...
     * @return $this
     */
    public function addFilterData($filterData)
    {
        $this->filterData[] = $filterData;
        $this->modifiedProperties[self::FILTER_DATA] = true;
    ...
    /**
     * @module ProductCategoryFilterStorage
     *
