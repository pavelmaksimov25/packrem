 ...
 */
class CmsSlotExternalDataTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
     ...
     * @module ShopCmsSlot|CmsSlot
     *
     * @param string|int $valuesKey
     * @param string $valuesValue
     *
     * @return $this
     */
    public function addValues($valuesKey, $valuesValue)
    {
        $this->values[$valuesKey] = $valuesValue;
        $this->modifiedProperties[self::VALUES] = true;
