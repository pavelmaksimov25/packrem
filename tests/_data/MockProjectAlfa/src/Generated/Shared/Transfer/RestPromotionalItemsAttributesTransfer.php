 ...
 */
class RestPromotionalItemsAttributesTransfer extends AbstractTransfer
{
    /**
     * @deprecated Use `skus` (plural) instead and provide a comma separated list.
     */
    ...
    /**
     * @module DiscountPromotionsRestApi|ProductsRestApi
     *
     * @deprecated Use `skus` (plural) instead and provide a comma separated list.
     *
