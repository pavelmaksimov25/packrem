 ...
 */
class CategoryDataFeedTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    public const JOIN_ABSTRACT_PRODUCT = 'joinAbstractProduct';
    ...
    protected $transferPropertyNameMap = [
        'join_abstract_product' => 'joinAbstractProduct',
        'joinAbstractProduct' => 'joinAbstractProduct',
        'JoinAbstractProduct' => 'joinAbstractProduct',
        'id_locale' => 'idLocale',
        'idLocale' => 'idLocale',
        'IdLocale' => 'idLocale',
    ...
    protected $transferMetadata = [
        self::JOIN_ABSTRACT_PRODUCT => [
            'type' => 'bool',
            'type_shim' => null,
            'name_underscore' => 'join_abstract_product',
            'is_collection' => false,
            'is_transfer' => false,
    ...
    /**
     * @module CategoryDataFeed
     *
     * @param bool|null $joinAbstractProduct
     *
     * @return $this
     */
    public function setJoinAbstractProduct($joinAbstractProduct)
    {
        $this->joinAbstractProduct = $joinAbstractProduct;
        $this->modifiedProperties[self::JOIN_ABSTRACT_PRODUCT] = true;
     ...
     * @return bool|null
     */
    public function getJoinAbstractProduct()
    {
        return $this->joinAbstractProduct;
    }
     ...
     * @return $this
     */
    public function setJoinAbstractProductOrFail($joinAbstractProduct)
    {
        if ($joinAbstractProduct === null) {
            $this->throwNullValueException(static::JOIN_ABSTRACT_PRODUCT);
        }

        return $this->setJoinAbstractProduct($joinAbstractProduct);
    }
     ...
     * @return bool
     */
    public function getJoinAbstractProductOrFail()
    {
        if ($this->joinAbstractProduct === null) {
            $this->throwNullValueException(static::JOIN_ABSTRACT_PRODUCT);
        }
     ...
     * @return $this
     */
    public function requireJoinAbstractProduct()
    {
        $this->assertPropertyIsSet(self::JOIN_ABSTRACT_PRODUCT);
    ...
    {
        return [
            'joinAbstractProduct' => $this->joinAbstractProduct,
    ...
    {
        return [
            'join_abstract_product' => $this->joinAbstractProduct,
    ...
    {
        return [
            'join_abstract_product' => $this->joinAbstractProduct instanceof AbstractTransfer ? $this->joinAbstractProduct->toArray(true, false) : $this->joinAbstractProduct,
    ...
    {
        return [
            'joinAbstractProduct' => $this->joinAbstractProduct instanceof AbstractTransfer ? $this->joinAbstractProduct->toArray(true, true) : $this->joinAbstractProduct,
