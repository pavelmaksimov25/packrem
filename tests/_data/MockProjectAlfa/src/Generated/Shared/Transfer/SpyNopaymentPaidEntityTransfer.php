 ...
 */
class SpyNopaymentPaidEntityTransfer extends AbstractEntityTransfer
{
    /**
     * @var string
     */
    public const ID_NOPAYMENT_PAID = 'idNopaymentPaid';
    ...
    protected $transferPropertyNameMap = [
        'id_nopayment_paid' => 'idNopaymentPaid',
        'idNopaymentPaid' => 'idNopaymentPaid',
        'IdNopaymentPaid' => 'idNopaymentPaid',
    ...
    protected $transferMetadata = [
        self::ID_NOPAYMENT_PAID => [
            'type' => 'integer',
            'type_shim' => null,
            'name_underscore' => 'id_nopayment_paid',
            'is_collection' => false,
            'is_transfer' => false,
     ...
     * @var string
     */
    public static $entityNamespace = 'Orm\Zed\Nopayment\Persistence\SpyNopaymentPaid';


    /**
     * @module 
     *
     * @param integer|null $idNopaymentPaid
     *
     * @return $this
     */
    public function setIdNopaymentPaid($idNopaymentPaid)
    {
        $this->idNopaymentPaid = $idNopaymentPaid;
        $this->modifiedProperties[self::ID_NOPAYMENT_PAID] = true;
     ...
     * @return $this
     */
    public function setIdNopaymentPaidOrFail($idNopaymentPaid)
    {
        if ($idNopaymentPaid === null) {
            $this->throwNullValueException(static::ID_NOPAYMENT_PAID);
        }

        return $this->setIdNopaymentPaid($idNopaymentPaid);
    }
     ...
     * @return integer
     */
    public function getIdNopaymentPaidOrFail()
    {
        if ($this->idNopaymentPaid === null) {
            $this->throwNullValueException(static::ID_NOPAYMENT_PAID);
        }
     ...
     * @return $this
     */
    public function requireIdNopaymentPaid()
    {
        $this->assertPropertyIsSet(self::ID_NOPAYMENT_PAID);
    ...
    {
        return [
            'idNopaymentPaid' => $this->idNopaymentPaid,
    ...
    {
        return [
            'id_nopayment_paid' => $this->idNopaymentPaid,
    ...
    {
        return [
            'id_nopayment_paid' => $this->idNopaymentPaid instanceof AbstractTransfer ? $this->idNopaymentPaid->toArray(true, false) : $this->idNopaymentPaid,
    ...
    {
        return [
            'idNopaymentPaid' => $this->idNopaymentPaid instanceof AbstractTransfer ? $this->idNopaymentPaid->toArray(true, true) : $this->idNopaymentPaid,
