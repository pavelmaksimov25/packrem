 ...
 */
class ProductAbstractGroupsTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    public const ID_PRODUCT_GROUPS = 'idProductGroups';
    ...
    protected $transferPropertyNameMap = [
        ...
        'IdProductAbstract' => 'idProductAbstract',
        'id_product_groups' => 'idProductGroups',
    ...
    protected $transferMetadata = [
        ...
        self::ID_PRODUCT_GROUPS => [
            'type' => 'array',
            'type_shim' => null,
            'name_underscore' => 'id_product_groups',
            'is_collection' => false,
            'is_transfer' => false,
            'is_value_object' => false,
            'rest_request_parameter' => 'no',
     ...
     * @module ProductGroup
     *
     * @param array|null $idProductGroups
     *
     * @return $this
     */
    public function setIdProductGroups(array $idProductGroups = null)
    {
        if ($idProductGroups === null) {
            $idProductGroups = [];
        }

        $this->idProductGroups = $idProductGroups;
        $this->modifiedProperties[self::ID_PRODUCT_GROUPS] = true;
     ...
     * @return array
     */
    public function getIdProductGroups()
    {
        return $this->idProductGroups;
    }

    /**
     * @module ProductGroup
     *
     * @param mixed $idProductGroup
     *
     * @return $this
     */
    public function addIdProductGroup($idProductGroup)
    {
        $this->idProductGroups[] = $idProductGroup;
        $this->modifiedProperties[self::ID_PRODUCT_GROUPS] = true;
     ...
     * @return $this
     */
    public function requireIdProductGroups()
    {
        $this->assertPropertyIsSet(self::ID_PRODUCT_GROUPS);
    ...
    public function toArrayNotRecursiveCamelCased(): array
    {
        return [
            ...
            'idProductGroups' => $this->idProductGroups,
        ];
    }
    ...
    public function toArrayNotRecursiveNotCamelCased(): array
    {
        return [
            ...
            'id_product_groups' => $this->idProductGroups,
        ];
    }
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'id_product_groups' => $this->idProductGroups instanceof AbstractTransfer ? $this->idProductGroups->toArray(true, false) : $this->idProductGroups,
        ];
    }
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'idProductGroups' => $this->idProductGroups instanceof AbstractTransfer ? $this->idProductGroups->toArray(true, true) : $this->idProductGroups,
        ];
    }
}
