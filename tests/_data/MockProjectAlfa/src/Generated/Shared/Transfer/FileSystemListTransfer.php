 ...
 */
class FileSystemListTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    public function setRecursive($recursive)
    {
        ...
        $this->modifiedProperties[self::RECURSIVE] = true;
     ...
     * @return $this
     */
    public function setRecursiveOrFail($recursive)
    {
        if ($recursive === null) {
            $this->throwNullValueException(static::RECURSIVE);
        }

        return $this->setRecursive($recursive);
    }
     ...
     * @return bool
     */
    public function getRecursiveOrFail()
    {
     ...
     * @return $this
     */
    public function requireRecursive()
    {
        $this->assertPropertyIsSet(self::RECURSIVE);
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'recursive' => $this->recursive instanceof AbstractTransfer ? $this->recursive->toArray(true, false) : $this->recursive,
        ];
    }
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'recursive' => $this->recursive instanceof AbstractTransfer ? $this->recursive->toArray(true, true) : $this->recursive,
        ];
    }
}
