...
class EventEntityTransfer extends AbstractTransfer
{
    ...
    /**
     * @module AssetStorage|Asset|Category|CmsBlock|CmsSlotBlockStorage|CmsSlotBlock|ConfigurableBundle|CustomerStorage|DataImport|EventBehavior|Merchant|PriceProduct|ProductMeasurementUnit|ProductOption|ProductSearch|Product|ShoppingList
     *
     * @param int|null $id
     *
     * @return $this
    ...
    /**
     * @module AssetStorage|EventBehavior|ProductCategory|ProductLabel|ProductOption|ProductReview|ProductSearch
     *
    ...
    /**
     * @module CustomerStorage|EventBehavior|ProductPageSearch|ProductStorage|ShoppingList
     *
    ...
    /**
     * @module EventBehavior|ShoppingList
     *
