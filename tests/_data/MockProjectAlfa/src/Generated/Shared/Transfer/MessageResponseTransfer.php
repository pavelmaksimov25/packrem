 ...
 */
class MessageResponseTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
     ...
     *
     * @param object|null|null $body
     *
     * @return $this
     */
    public function setBody(object $body = null)
    {
        $this->body = $body;
     ...
     * @return $this
     */
    public function setBodyOrFail(object $body)
    {
