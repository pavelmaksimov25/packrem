...
class TabsViewTransfer extends AbstractTransfer
{
    ...
    /**
     * @module CategoryGui|CategoryImageGui|Category|CmsBlockGui|CmsGui|ConfigurableBundleGui|ContentGui|CountryGui|CurrencyGui|CustomerGroup|Discount|FileManagerGui|Gui|LocaleGui|MerchantGui|PaymentGui|PriceProductScheduleGui|ProductAlternativeGui|ProductDiscontinuedGui|ProductLabelGui|ProductListGui|ProductManagement|ProductOption|ProductRelationGui|ProductRelation|ProductSetGui|ShipmentGui|StockGui|StoreContextGui|StoreGui
     *
    ...
    /**
     * @module CategoryGui|Category|CmsBlockGui|CmsGui|ConfigurableBundleGui|ContentGui|CustomerGroup|Discount|FileManagerGui|Gui|MerchantGui|PaymentGui|ProductLabelGui|ProductListGui|ProductManagement|ProductOption|ProductRelationGui|ProductRelation|ProductSetGui|ShipmentGui|StockGui|StoreGui
     *
    ...
    /**
     * @module CategoryGui|Category|CmsBlockGui|CmsGui|ConfigurableBundleGui|CountryGui|CurrencyGui|CustomerGroup|Discount|FileManagerGui|Gui|LocaleGui|MerchantGui|PaymentGui|ProductLabelGui|ProductListGui|ProductManagement|ProductOption|ProductRelationGui|ProductRelation|ProductSetGui|ShipmentGui|StockGui|StoreGui
     *
