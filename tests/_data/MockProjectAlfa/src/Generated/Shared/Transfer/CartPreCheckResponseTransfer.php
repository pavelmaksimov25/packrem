...
class CartPreCheckResponseTransfer extends AbstractTransfer
{
    ...
    /**
     * @module AvailabilityCartConnector|Cart|ConfigurableBundleCart|DiscountPromotion|Merchant|PriceCartConnector|ProductBundle|ProductCartConnector|ProductCustomerPermission|ProductDiscontinued|ProductList|ProductMeasurementUnit|ProductOptionCartConnector|ProductPackagingUnit|ProductQuantity|ShipmentCartConnector
     *
