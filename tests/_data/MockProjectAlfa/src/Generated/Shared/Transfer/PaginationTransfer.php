...
class PaginationTransfer extends AbstractTransfer
{
    ...
    /**
     * @module CustomerPage|SalesReturnPage|AgentAuthRestApi|Agent|Asset|AvailabilityNotification|AvailabilityNotificationsRestApi|Category|CompanyBusinessUnit|CompanyRole|CompanyUnitAddress|CompanyUserInvitation|CompanyUser|Currency|Customer|FileManager|MerchantRelationship|Merchant|OrdersRestApi|ProductAlternative|ProductAttribute|ProductAttributesRestApi|ProductConfiguration|ProductDiscontinued|ProductImage|ProductLabel|ProductList|Product|PublishAndSynchronizeHealthCheck|QuoteRequest|SalesReturn|SalesReturnsRestApi|Sales|Shipment|StoreStorage|Store|TaxProductStorage|Tax|Url
     *
    ...
    /**
     * @module CustomerPage|SalesReturnPage|Agent|AvailabilityNotification|CompanyBusinessUnit|CompanyRole|CompanyUnitAddress|CompanyUserInvitation|CompanyUser|Currency|Customer|MerchantRelationship|Merchant|ProductAttribute|ProductConfiguration|ProductImage|Product|QuoteRequest|SalesReturn|Sales|Shipment|StoreStorage|Store
     *
    ...
    /**
     * @module CustomerPage|SalesReturnPage|Agent|AvailabilityNotification|CompanyBusinessUnit|CompanyRole|CompanyUnitAddress|CompanyUserInvitation|CompanyUser|Currency|Customer|GlueApplication|GlueJsonApiConvention|MerchantRelationship|Merchant|ProductAttribute|ProductConfiguration|ProductImage|Product|QuoteRequest|SalesReturn|Sales|Shipment|StoreStorage|Store
     *
    ...
    /**
     * @module CustomerPage|SalesReturnPage|Agent|AvailabilityNotification|CmsBlockProductConnector|CmsSlotBlockGui|CmsSlotBlockProductCategoryGui|CmsSlotBlock|CompanyBusinessUnit|CompanyRole|CompanyUnitAddress|CompanyUserInvitation|CompanyUser|Currency|Customer|MerchantRelationship|Merchant|ProductAttribute|ProductConfiguration|ProductImage|Product|QuoteRequest|SalesReturn|Sales|Shipment|StoreStorage|Store
     *
    ...
    /**
     * @module AssetStorage|Asset|CategoryImageStorage|Category|Currency|CustomerStorage|FileManagerStorage|FileManager|GlueApplication|GlueJsonApiConvention|ProductAlternativeStorage|ProductAlternative|ProductAttribute|ProductConfigurationShoppingList|ProductConfigurationStorage|ProductConfiguration|ProductDiscontinuedStorage|ProductDiscontinued|ProductImage|ProductLabelSearch|ProductLabel|ProductListSearch|ProductListStorage|ProductList|Product|PublishAndSynchronizeHealthCheckSearch|PublishAndSynchronizeHealthCheckStorage|PublishAndSynchronizeHealthCheck|Shipment|StoreStorage|Store|TaxProductStorage|TaxStorage|Tax|Url
     *
