 ...
 */
class SpyStoreStorageEntityTransfer extends AbstractEntityTransfer
{
    /**
     * @var string
     */
    public const ID_SPY_STORE_STORAGE = 'idSpyStoreStorage';
    ...
    protected $transferPropertyNameMap = [
        'id_spy_store_storage' => 'idSpyStoreStorage',
        'idSpyStoreStorage' => 'idSpyStoreStorage',
        'IdSpyStoreStorage' => 'idSpyStoreStorage',
        'fk_store' => 'fkStore',
        'fkStore' => 'fkStore',
        'FkStore' => 'fkStore',
    ...
    protected $transferMetadata = [
        self::ID_SPY_STORE_STORAGE => [
            'type' => 'integer',
            'type_shim' => null,
            'name_underscore' => 'id_spy_store_storage',
            'is_collection' => false,
            'is_transfer' => false,
     ...
     * @var string
     */
    public static $entityNamespace = 'Orm\Zed\StoreStorage\Persistence\SpyStoreStorage';


    /**
     * @module 
     *
     * @param integer|null $idSpyStoreStorage
     *
     * @return $this
     */
    public function setIdSpyStoreStorage($idSpyStoreStorage)
    {
        $this->idSpyStoreStorage = $idSpyStoreStorage;
        $this->modifiedProperties[self::ID_SPY_STORE_STORAGE] = true;
     ...
     * @return $this
     */
    public function setIdSpyStoreStorageOrFail($idSpyStoreStorage)
    {
        if ($idSpyStoreStorage === null) {
            $this->throwNullValueException(static::ID_SPY_STORE_STORAGE);
        }

        return $this->setIdSpyStoreStorage($idSpyStoreStorage);
    }
     ...
     * @return integer
     */
    public function getIdSpyStoreStorageOrFail()
    {
        if ($this->idSpyStoreStorage === null) {
            $this->throwNullValueException(static::ID_SPY_STORE_STORAGE);
        }
     ...
     * @return $this
     */
    public function requireIdSpyStoreStorage()
    {
        $this->assertPropertyIsSet(self::ID_SPY_STORE_STORAGE);
    ...
    {
        return [
            'idSpyStoreStorage' => $this->idSpyStoreStorage,
    ...
    {
        return [
            'id_spy_store_storage' => $this->idSpyStoreStorage,
    ...
    {
        return [
            'id_spy_store_storage' => $this->idSpyStoreStorage instanceof AbstractTransfer ? $this->idSpyStoreStorage->toArray(true, false) : $this->idSpyStoreStorage,
    ...
    {
        return [
            'idSpyStoreStorage' => $this->idSpyStoreStorage instanceof AbstractTransfer ? $this->idSpyStoreStorage->toArray(true, true) : $this->idSpyStoreStorage,
