 ...
 */
class SpyVaultDepositEntityTransfer extends AbstractEntityTransfer
{
    /**
     * @var string
     */
    public const ID_VAULT_DEPOSIT = 'idVaultDeposit';
    ...
    protected $transferPropertyNameMap = [
        'id_vault_deposit' => 'idVaultDeposit',
        'idVaultDeposit' => 'idVaultDeposit',
        'IdVaultDeposit' => 'idVaultDeposit',
        'data_type' => 'dataType',
        'dataType' => 'dataType',
        'DataType' => 'dataType',
    ...
    protected $transferMetadata = [
        self::ID_VAULT_DEPOSIT => [
            'type' => 'integer',
            'type_shim' => null,
            'name_underscore' => 'id_vault_deposit',
            'is_collection' => false,
            'is_transfer' => false,
     ...
     * @var string
     */
    public static $entityNamespace = 'Orm\Zed\Vault\Persistence\SpyVaultDeposit';


    /**
     * @module 
     *
     * @param integer|null $idVaultDeposit
     *
     * @return $this
     */
    public function setIdVaultDeposit($idVaultDeposit)
    {
        $this->idVaultDeposit = $idVaultDeposit;
        $this->modifiedProperties[self::ID_VAULT_DEPOSIT] = true;
     ...
     * @return $this
     */
    public function setIdVaultDepositOrFail($idVaultDeposit)
    {
        if ($idVaultDeposit === null) {
            $this->throwNullValueException(static::ID_VAULT_DEPOSIT);
        }

        return $this->setIdVaultDeposit($idVaultDeposit);
    }
     ...
     * @return integer
     */
    public function getIdVaultDepositOrFail()
    {
        if ($this->idVaultDeposit === null) {
            $this->throwNullValueException(static::ID_VAULT_DEPOSIT);
        }
     ...
     * @return $this
     */
    public function requireIdVaultDeposit()
    {
        $this->assertPropertyIsSet(self::ID_VAULT_DEPOSIT);
    ...
    {
        return [
            'idVaultDeposit' => $this->idVaultDeposit,
    ...
    {
        return [
            'id_vault_deposit' => $this->idVaultDeposit,
    ...
    {
        return [
            'id_vault_deposit' => $this->idVaultDeposit instanceof AbstractTransfer ? $this->idVaultDeposit->toArray(true, false) : $this->idVaultDeposit,
    ...
    {
        return [
            'idVaultDeposit' => $this->idVaultDeposit instanceof AbstractTransfer ? $this->idVaultDeposit->toArray(true, true) : $this->idVaultDeposit,
