 ...
 */
class SpyPublishAndSynchronizeHealthCheckStorageEntityTransfer extends AbstractEntityTransfer
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    public static $entityNamespace = 'Orm\Zed\PublishAndSynchronizeHealthCheckStorage\Persistence\SpyPublishAndSynchronizeHealthCheckStorage';


    /**
     * @module 
     *
     * @param string|null $idPublishAndSynchronizeHealthCheckStorage
     *
     * @return $this
     */
