 ...
 */
class SalesShipmentCriteriaBuilder extends AbstractDataBuilder
{
    /**
     * @var \Faker\Generator
     */
     ...
     */
    public function build(): SalesShipmentCriteriaTransfer
    {
        /** @var \Generated\Shared\Transfer\SalesShipmentCriteriaTransfer $transfer */
     ...
     * @return \Generated\Shared\Transfer\SalesShipmentCriteriaTransfer
     */
    public function getTransfer(): SalesShipmentCriteriaTransfer
    {
        return new SalesShipmentCriteriaTransfer;
    }
     ...
     * @return $this
     */
    public function withSalesShipmentConditions($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('salesShipmentConditions', $overrideOrBuilder, false);

            return $this;
        }
        $this->buildDependency('salesShipmentConditions', $overrideOrBuilder);
     ...
     * @return $this
     */
    public function withAnotherSalesShipmentConditions($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('salesShipmentConditions', $overrideOrBuilder, true);

            return $this;
        }
        $this->buildDependency('salesShipmentConditions', $overrideOrBuilder, true);
