...
class CategoryCriteriaBuilder extends AbstractDataBuilder
{
     ...
     * @return $this
     */
    public function withCategoryConditions($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('categoryConditions', $overrideOrBuilder, false);

            return $this;
        }
        $this->buildDependency('categoryConditions', $overrideOrBuilder);
     ...
     * @return $this
     */
    public function withAnotherCategoryConditions($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('categoryConditions', $overrideOrBuilder, true);

            return $this;
        }
        $this->buildDependency('categoryConditions', $overrideOrBuilder, true);
