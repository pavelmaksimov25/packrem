 ...
 */
class CompanyRoleResponseBuilder extends AbstractDataBuilder
{
    /**
     * @var \Faker\Generator
     */
    ...
    protected $dependencies = [
        'companyRoleTransfer' => 'CompanyRole',
     ...
     */
    public function build(): CompanyRoleResponseTransfer
    {
        /** @var \Generated\Shared\Transfer\CompanyRoleResponseTransfer $transfer */
     ...
     * @return \Generated\Shared\Transfer\CompanyRoleResponseTransfer
     */
    public function getTransfer(): CompanyRoleResponseTransfer
    {
     ...
     * @return $this
     */
    public function withCompanyRoleTransfer($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('companyRoleTransfer', $overrideOrBuilder, false);

            return $this;
        }
        $this->buildDependency('companyRoleTransfer', $overrideOrBuilder);
     ...
     * @return $this
     */
    public function withAnotherCompanyRoleTransfer($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('companyRoleTransfer', $overrideOrBuilder, true);

            return $this;
        }
        $this->buildDependency('companyRoleTransfer', $overrideOrBuilder, true);
