 ...
 */
class PersistentCartChangeBuilder extends AbstractDataBuilder
{
    /**
     * @var \Faker\Generator
     */
     ...
     */
    public function build(): PersistentCartChangeTransfer
    {
        /** @var \Generated\Shared\Transfer\PersistentCartChangeTransfer $transfer */
     ...
     * @return \Generated\Shared\Transfer\PersistentCartChangeTransfer
     */
    public function getTransfer(): PersistentCartChangeTransfer
    {
     ...
     * @return $this
     */
    public function withQuoteUpdateRequestAttributes($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('quoteUpdateRequestAttributes', $overrideOrBuilder, false);

            return $this;
        }
        $this->buildDependency('quoteUpdateRequestAttributes', $overrideOrBuilder);
     ...
     * @return $this
     */
    public function withAnotherQuoteUpdateRequestAttributes($overrideOrBuilder = [])
    {
        if ($overrideOrBuilder instanceof AbstractDataBuilder) {
            $this->addDependencyBuilder('quoteUpdateRequestAttributes', $overrideOrBuilder, true);

            return $this;
        }
        $this->buildDependency('quoteUpdateRequestAttributes', $overrideOrBuilder, true);
