...
class __TwigTemplate_408db467825e2d10029e1cca4c771b32 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 2
        $this->loadTemplate("@WebProfiler/Profiler/toolbar.html.twig", "@WebProfiler/Profiler/toolbar_js.html.twig", 2)->display(twig_array_merge($context, ["templates" => ["request" => "@WebProfiler/Profiler/cancel.html.twig"], "profile" => null, "profiler_url" => $this->env->getFunction('url')->getCallable()("_profiler", ["token" =>         // line 7
...
/*]]>*/</script>
", "@WebProfiler/Profiler/toolbar_js.html.twig", "/data/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/toolbar_js.html.twig");
    }
}
