...
class __TwigTemplate_6b5e3dc15fdc5bd52d3207106badd61d extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if (( !array_key_exists("link", $context) || (isset($context["link"]) || array_key_exists("link", $context) ? $context["link"] : (function () { throw new RuntimeError('Variable "link" does not exist.', 2, $this->source); })()))) {
            echo "<a href=\"";
            echo $this->env->getFunction('url')->getCallable()("_profiler", ["token" => (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 2, $this->source); })()), "panel" => (isset($context["name"]) || array_key_exists("name", $context) ? $context["name"] : (function () { throw new RuntimeError('Variable "name" does not exist.', 2, $this->source); })())]);
            echo "\">";
        }
        // line 3
...
", "@WebProfiler/Profiler/toolbar_item.html.twig", "/data/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/toolbar_item.html.twig");
    }
}
